...
def main():
    ...
    print(f"MAPS10_HAS_BOUNDS={profile['has_bounds']}")
    print(f"MAPS10_SPAWN_X={profile['spawn_x']:.3f}")
    print(f"MAPS10_SPAWN_Y={profile['spawn_y']:.3f}")
    print(f"MAPS10_SPAWN_YAW={profile['spawn_yaw']:.0f}")
    print(f"MAPS10_BOUNDS='{profile['bounds']}'")
