...
class SideDepthCloudMerger(Node):
    def __init__(self):
        super().__init__("maps8_side_depth_cloud_merger")
        ...
        self.pub = self.create_publisher(PointCloud2, "/maps8/merged_scan_cloud", 2)
        self.timer = self.create_timer(0.8, self.publish_merged)
        self.get_logger().info("Maps8 cloud merger aktif: lidar + right depth + left depth")
