...
class GeneralAutonomousExplorer(Node):
    ...
    def __init__(self, args):
        super().__init__("maps12_general_explorer", parameter_overrides=[
        ...
        self.create_subscription(PointCloud2, "/maps8/merged_scan_cloud", self.cloud_cb, 2)
        ...
        self.get_logger().info(
            "Maps12 genel otonom explorer basladi: sabit harita siniri, "
    ...
    def read_bounds(self):
        raw = os.environ.get("MAPS10_BOUNDS", "").strip()
        if not raw:
            return None
        try:
