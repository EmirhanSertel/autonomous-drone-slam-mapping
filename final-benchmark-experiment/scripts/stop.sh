...
echo "Maps12 prosesleri durduruluyor..."
tmux kill-session -t maps12_live 2>/dev/null || true
tmux kill-session -t maps12_run 2>/dev/null || true
tmux kill-session -t maps10_live 2>/dev/null || true
tmux kill-session -t maps8_run 2>/dev/null || true
tmux kill-session -t bugramap_live 2>/dev/null || true
