#!/usr/bin/env python3
# Maps8: RTAB-Map + lidar + ek sag/sol depth kamera bulutlari
# RTAB-Map kurulumu multi-RGBD desteklemedigi icin front RGB-D tek kalir.
# Sag/sol depth camera point cloud'lari lidar ile /maps8/merged_scan_cloud olarak birlestirilir.
...
def generate_launch_description():
    ...
    # Maps12 DB dosyasını kendi outputs/ klasörüne kaydet
    maps12_db = str(Path.home() / "Desktop/Project-Final/final-benchmark-experiment/outputs/rtabmap.db")
    os.makedirs(str(Path.home() / "Desktop/Project-Final/final-benchmark-experiment/outputs"), exist_ok=True)

    rtabmap_params = {
        'database_path': maps12_db,
    ...
    rtabmap = Node(
        ...
        remappings=[
            ('rgbd_image', '/rgbd_image_front'),
            ('scan_cloud', '/maps8/merged_scan_cloud'),
