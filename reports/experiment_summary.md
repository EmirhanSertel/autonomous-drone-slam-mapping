...
Bu dosya GitHub'a büyük çıktı dosyaları koymadan deney sonuçlarını özetlemek için hazırlanmıştır.

## Çıktı Politikası

RTAB-Map veritabanları, PLY nokta bulutları, mesh dosyaları, canlı snapshotlar ve render çıktıları büyük olduğu için repoya eklenmez. Bu dosyalar yerel deney çalıştırıldığında yeniden üretilir veya harici depoda saklanır.

GitHub içinde yalnızca küçük dokümantasyon görselleri tutulur:
...
## Repoya Konmayan Sonuç Dosyaları

Örnek olarak aşağıdaki dosyalar yerelde bulunabilir ancak GitHub'a eklenmemelidir:
